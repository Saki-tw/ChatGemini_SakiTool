...
### 📅 v1.0.9（2025-11-29）— 🚀 API 現代化與模型更新

**核心更新**：

- 🔄 **Google GenAI SDK 遷移**：從舊版 `google-generativeai` 遷移至最新 `google import genai` SDK，符合 Google 2025-11-30 棄用時程
- 🤖 **Gemini 3 Pro Preview 支援**：新增 Google 最新 Gemini 3 Pro Preview 模型，思考預算最高 65,536 tokens
- 🖼️ **Imagen 4 模型更新**：更新至 Imagen 4.0（標準/Ultra/Fast），提供更高品質圖片生成
- 🎬 **影音模組全面更新**：Veo 3.1、Flow Engine、字幕生成器等模組已更新至最新 API
- 🐛 **Rich UI 格式修復**：修正 100+ 處 Rich 格式標籤不匹配問題，確保終端顯示一致性
- 🧹 **專案清理**：移除過時的 `gemini-2.0-flash-exp` 引用，清理備份檔案與 deprecated 模組
