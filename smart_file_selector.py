...
class SmartFileSelector:
        ...
        while True:
            try:
                ...
                if not valid_indices:
                    self.console.print("[yellow]⚠ 未輸入有效編號，請重新輸入[/yellow]")
                    continue
                ...
                self.console.print("[yellow]⚠ 輸入格式錯誤，請輸入有效編號[/yellow]")
    ...
    def smart_select(
        ...
        if not similar_files:
            self.console.print("[yellow]⚠ 未找到相似檔案[/yellow]")
            return None
