#!/usr/bin/env python3
"""
Phase 5 自動 i18n 轉換腳本
批次處理所有 gemini_*.py 檔案
"""
import re
import os
...
def add_i18n_import(filepath: Path) -> bool:
    ...
    # 尋找適當位置插入
    # 在 from rich 之後，或在第一個 import 之後
    patterns = [
...
def main():
    ...
    target_files = [
        ...
        'gemini_video_compositor.py',
        'gemini_video_effects.py',
